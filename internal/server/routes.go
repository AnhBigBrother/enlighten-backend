...
func RegisterRoutes() http.Handler {
	...
	authRouter.HandleFunc("POST /signout", guard.Auth(usersHandler.SignOut))
	...
	signedUsersRouter.HandleFunc("PATCH /", guard.Auth(usersHandler.UpdateMe))
	...
	postsRouter.HandleFunc("GET /saved", guard.Auth(postsHandler.GetAllSavedPost))
	...
	postsRouter.HandleFunc("GET /{post_id}/check", guard.Auth(postsHandler.CheckPost))
	postsRouter.HandleFunc("POST /{post_id}/save", guard.Auth(postsHandler.SavePost))
	postsRouter.HandleFunc("DELETE /{post_id}/save", guard.Auth(postsHandler.UnSavePost))
	...
	postsRouter.HandleFunc("GET /{post_id}/comments/{comment_id}/check", guard.Auth(commentsHandler.CheckComment))
